...
include::../../../main/java/srcJava_vishiaBase/org/vishia/fpga/VhdlConv.java[tag=genExpressionHead]
----
...
----
//In source: main/java/srcJava_vishiaBase/org/vishia/fpga/VhdlConv.java
include::../../../main/java/srcJava_vishiaBase/org/vishia/fpga/VhdlConv.java[tag=genExpressionParts]
----
